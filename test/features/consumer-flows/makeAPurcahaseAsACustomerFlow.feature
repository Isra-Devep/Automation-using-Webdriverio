...
Feature: A user wants to make a purchase from the application.
        ...
        Scenario:  A Signed-in user purchases an item(s) from a drop using pickup mode. 
                ...
                When Cart is updated then the user adds more items to the cart and verifies the cart again
                ...
                Then The user can add a mastercard/visa/discover/american union card
